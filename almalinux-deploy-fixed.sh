...
display_summary() {
    ...
    echo -e "${BLUE}Start services:${NC} cd $INSTALL_DIR && docker-compose up -d"
    echo -e "${BLUE}Stop services:${NC} cd $INSTALL_DIR && docker-compose down"
    echo -e "${BLUE}View logs:${NC} cd $INSTALL_DIR && docker-compose logs -f"
    echo -e "${BLUE}Restart a service:${NC} cd $INSTALL_DIR && docker-compose restart [service_name]"
    echo ""
